        ...
        if (v) {
            if (props.editing) {
                Object.assign(form, {
                    ...
                    frps_port: props.editing.frps_port,
                    frp_token: props.editing.frp_token,
                    agent_url: props.editing.agent_url,
                    agent_token: props.editing.agent_token,
                    is_default: props.editing.is_default,
                    remark: props.editing.remark ?? '',
                })
            } else {
                Object.assign(form, {
                    name: '',
...
<template>
    ...
    >
        <el-form ref="formRef" :model="form" :rules="rules" label-width="120px">
            ...
            <el-form-item label="公网地址" prop="host"
                ><el-input v-model="form.host" placeholder="IP 或域名"
            /></el-form-item>
            <el-form-item label="frps 端口" prop="frps_port"
                ><el-input-number v-model="form.frps_port" :min="1" :max="65535"
            /></el-form-item>
            <el-form-item label="frp token" prop="frp_token"
                ><el-input v-model="form.frp_token" show-password
            /></el-form-item>
            <el-form-item label="Agent 地址" prop="agent_url"
                ><el-input v-model="form.agent_url" placeholder="http://1.2.3.4:7400"
            /></el-form-item>
            <el-form-item label="Agent token" prop="agent_token"
                ><el-input v-model="form.agent_token" show-password
            /></el-form-item>
